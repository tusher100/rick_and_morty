...
class HomeScreen extends HookConsumerWidget {
        ...
        children: [
          if (state.statusFilter != null || state.speciesFilter != null)
            ActiveFiltersBar(
              ...
              onClearStatus: () => notifier.setFilters(
                status: null,
                species: state.speciesFilter,
              ),
              onClearSpecies: () => notifier.setFilters(
          ...
          Expanded(
            child: state.characters.when(
              ...
              error: (err, stack) =>
                  HomeErrorState(onRetry: () => notifier.fetchInitial()),
            ),
          ),
        ],
      ),
  ...
  Widget _buildCharacterGrid(
    ...
    ValueNotifier<Set<Character>> selections,
  ...
  PreferredSizeWidget _buildNormalAppBar(
    ...
    return AppBar(
      ...
      title: !isSearchExpanded.value
          ...
          : _buildSearchField(ref, searchController, debouncer),
      actions: [
        IconButton(
          icon: Icon(
        ...
        IconButton(
          icon: Icon(
            Icons.tune,
            size: 24.w,
            color: (state.statusFilter != null || state.speciesFilter != null)
                ? AppColors.secondary
    ...
    return TextField(
      ...
      onChanged: (val) {
        ...
        debouncer.value = Timer(
          ...
          () => ref.read(characterListProvider.notifier).search(val),
        );
      },
    );
  }
      ...
      actions: [
        ...
        IconButton(
          ...
          onPressed: () async {
            ...
            selections.value = {};
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Restored selected characters!')),
            );
          },
        ),
      ],
  ...
  void _showFilterSheet(
    ...
    showModalBottomSheet(
      ...
      builder: (context) => FilterSheet(
        ...
        onApply: (status, species) => ref
            .read(characterListProvider.notifier)
            .setFilters(status: status, species: species),
      ),
    );
  }
}
